     ...
     &     (ame**2 - p1p2*1D0)) + 
     &  (B0ax15em1*(ame**4*kp2*(ame**2 + p1p2 - kp2*1D0)*
     ...
     &       ame**2*kp1*2D0)) + 
     &  (B0ax25em2*(kp1**3*kp2*(p2p4 - p2p3*1D0) + 
     ...
     &              (p2p3 + p2p4 - p1p3*1D0 - p1p4*1D0) + 
     &             p2p4*(p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)*
     &              2D0)))*(m1**2 + m2**2 - p1p2*4D0))/
     &   (kp1*kp2*kp3*kp4*(ampi**2 + p3p4)*
     &     (ame**2 - p1p2*1D0)) + 
     &  (ame**2*B0aeem1*5.D-1*
     &     (-(kp1**4*kp2*(kp3 + kp4)*1D0*
     &          (ampi**2 - p3p4*1D0)) + 
     &       kp1**3*kp2*(kp3**2*(p2p4 - p1p4*1D0) + 
     &          kp2*(kp3 + kp4)*(ampi**2 - p3p4*1D0)*2D0 + 
     &          kp3*(kp4*
     &              (p1p3 + p1p4 - p2p3*1D0 - p2p4*1D0) + 
     ...
     &              2D0 + p1p2*(ampi**2 - p3p4*1D0)*2D0)) + 
     &       kp1**2*(-(kp2**3*(kp3 + kp4)*1D0*
     &             (ampi**2 - p3p4*1D0)) - 
     &          ame**2*kp3*kp4*(ame**2 - p1p2*1D0)*
     &           (kp3 + p1p3 + p2p4 - kp4*1D0 - p1p4*1D0 - 
     &             p2p3*1D0)*2D0 + 
     &          kp2**2*(kp3**2*(p1p4 - p2p4*1D0) + 
     &             kp4*(kp4*(p1p3 - p2p3*1D0) + 
     ...
     &                  + p1p2*(p3p4 - ampi**2*1D0)*4D0)) + 
     &          kp2*(kp3**2*p1p2*(p1p4 - p2p4*1D0)*2D0 + 
     &             kp3*(p1p2**2*(p3p4 - ampi**2*1D0) + 
     &                ame**4*(ampi**2 - p3p4*1D0) - 
     &                p1p2*2D0*
     &                 (p2p4*
     &                    (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &                    2D0 + 
     &                   kp4*(p1p3 + p1p4 + p2p3 - p2p4*3D0))
     &                 + ame**2*kp4*(p2p3 - p2p4*1D0)*4D0) + 
     &             kp4*(ame**4*(ampi**2 - p3p4*1D0) + 
     &                p1p2*
     ...
     &                    (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &                    4D0)))) + 
     &       kp2*(-(ame**2*kp2**3*(kp3 + kp4)*
     &             (ampi**2 - p3p4*1D0)*2D0) - 
     &          kp3*kp4*(ame**4 - p1p2**2*1D0)*
     &           (ame**2*(kp3 - kp4*1D0) + 
     ...
     &              (-((ame**2 + p1p2)*1D0*
     &                   (p1p4 - p2p4*1D0)) + 
     &                kp4*2D0*(p1p2 + ame**2*2D0)) + 
     &             kp3*((ame**2 + p1p2)*p1p4*
     &                 (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0
     &                  - kp4**2*2D0*(p1p2 + ame**2*2D0) + 
     &                kp4*
     &                 ((p1p4 + p2p3)*(ame**2 - p1p2*1D0) - 
     &                   p2p4*1D0*(p1p2 + ame**2*3D0) + 
     &                   p1p3*(ame**2 + p1p2*3D0)))) + 
     &          kp2**2*(ame**2*kp3**2*(p1p4 - p2p4*1D0)*2D0 + 
     &             kp4*(p1p2**2*(p3p4 - ampi**2*1D0) + 
     &                ame**2*
     ...
     &                    4D0)) + 
     &             kp3*(p1p2**2*(p3p4 - ampi**2*1D0) + 
     &                kp4*p1p2*(p1p3 - p1p4*1D0)*2D0 + 
     &                ame**2*
     &                 (ame**2*(ampi**2 - p3p4*1D0) + 
     &                   kp4*2D0*(p2p3 + p2p4 - p1p3*2D0) + 
     &                   p1p4*
     &                    (p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)*
     &                    4D0)))) + 
     &       kp1*(ame**2*kp3*kp4*(ame**4 - p1p2**2*1D0)*
     &           (kp3 + p1p3 + p2p4 - kp4*1D0 - p1p4*1D0 - 
     &             p2p3*1D0)*2D0 + 
     &          kp2**3*(kp3 + kp4)*(ampi**2 - p3p4*1D0)*2D0*
     &           (p1p2 + ame**2*2D0) - 
     &          kp2**2*2D0*
     &           (kp3**2*(ame**2 + p1p2)*(p1p4 - p2p4*1D0) + 
     &             kp4*(p1p2**2*(p3p4 - ampi**2*1D0) + 
     &                p1p2*
     &                 (kp4*(p1p3 - p2p3*1D0) + 
     &                   p1p3*
     ...
     &                    (p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)*
     &                    2D0 + 
     &                   kp4*(p1p4 + p2p3*2D0 - p1p3*3D0)) + 
     &                ame**2*
     &                 (ame**2*(ampi**2 - p3p4*1D0) + 
     &                   p2p4*
     &                    (p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)*
     &                    2D0 + 
     &                   kp4*(p1p3 + p2p4*2D0 - p1p4*3D0))))
     &           - kp2*1D0*(ame**2 - p1p2*1D0)*
     &           (kp3**2*(ame**2 + p1p2)*
     &              (p2p4 - p1p4*1D0 + kp4*2D0) - 
     &             kp4*(ame**2 + p1p2)*1D0*
     &              (kp4*(p1p3 - p2p3*1D0) + 
     &                p2p3*
     &                 (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0
     ...
     &       ame**2*kp2*2D0)) + 
     &  (ame**2*B0aeem2*5.D-1*
     &     (-(ame**2*kp2*kp3*kp4*(ame**2 + p1p2 - kp2*1D0)*
     &          (ame**2 - p1p2*1D0)*
     &          (kp3 + p1p4 + p2p3 - kp4*1D0 - p1p3*1D0 - 
     &            p2p4*1D0)*2D0) - 
     &       ame**2*kp1**4*(kp3 + kp4)*(ampi**2 - p3p4*1D0)*
     &        2D0 + kp1**2*
     &        (kp2**3*(kp3 + kp4)*(ampi**2 - p3p4*1D0)*2D0 - 
     &          1D0*(ame**2 - p1p2*1D0)*
     &           (-(kp4*(ame**2 + p1p2)*1D0*
     ...
     &                     (ame**2 - p1p2*1D0)) + 
     &                   p1p3*(p1p2 + ame**2*3D0) - 
     &                   p2p4*1D0*(ame**2 + p1p2*3D0)))) - 
     &          kp2*2D0*(-(kp3**2*(ame**2 + p1p2)*1D0*
     &                (p1p4 - p2p4*1D0)) + 
     &             kp4*(p1p2**2*(p3p4 - ampi**2*1D0) + 
     &                ame**2*
     &                 (kp4*(p2p3 - p1p3*1D0) + 
     ...
     &                    (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &                    2D0 + 
     &                   kp4*(p2p4 + p1p3*2D0 - p2p3*3D0)) + 
     &                p1p2*
     &                 (p2p4*
     &                    (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &                    2D0 + 
     &                   kp4*(p2p3 + p1p4*2D0 - p2p4*3D0))))
     &           + kp2**2*
     &           (kp3**2*(p2p4 - p1p4*1D0) + 
     &             kp3*(kp4*
     &                 (p1p3 + p1p4 - p2p3*1D0 - p2p4*1D0) + 
     ...
     &                 (p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)*2D0
     &                  + p1p2*(p3p4 - ampi**2*1D0)*4D0))) + 
     &       kp1**3*(ame**2*kp3**2*(p2p4 - p1p4*1D0)*2D0 + 
     &          kp3*(kp2**2*(p3p4 - ampi**2*1D0) + 
     &             p1p2**2*(p3p4 - ampi**2*1D0) + 
     &             kp4*p1p2*(p2p4 - p2p3*1D0)*2D0 + 
     &             kp2*(ampi**2 - p3p4*1D0)*2D0*
     &              (p1p2 + ame**2*2D0) + 
     &             ame**2*
     &              (ame**2*(ampi**2 - p3p4*1D0) + 
     &                kp4*(p1p3 + p1p4)*2D0 + p2p4**2*4D0 - 
     &                p2p4*(kp4 + p1p4 + p2p3 - p1p3*1D0)*4D0)
     &             ) + kp4*
     ...
     &                   (p1p4 + p2p3)*(ame**2 - p1p2*3D0) + 
     &                   p1p3*(ame**2 + p1p2*5D0)))) + 
     &          kp2**2*(kp3**2*p1p2*(p2p4 - p1p4*1D0)*2D0 + 
     &             kp4*(ame**4*(ampi**2 - p3p4*1D0) + 
     &                p1p2*
     &                 (p1p2*(p3p4 - ampi**2*1D0) + 
     &                   kp4*(p2p3 - p1p3*1D0)*2D0 + 
     ...
     &        (kp3 + p1p4 + p2p3 - kp4*1D0 - p1p3*1D0 - 
     &          p2p4*1D0)*(m1**2 + m2**2 + kp2*4D0 - p1p2*4D0)
     &         + kp1**3*(ame**2*m1**2*p2p3 + 
     &          m2**2*p1p2*p2p3 - kp2*m2**2*p2p3*1D0 - 
     &          ame**4*p1p3*2D0 - ame**2*kp2*p1p3*2D0 + 
     &          ame**4*p1p4*2D0 + ame**2*kp2*p1p4*2D0 + 
     &          ame**4*p2p3*2D0 + ame**2*m2**2*p2p3*2D0 - 
     &          ame**2*kp3*2D0*(p1p2 + ame**2*2D0) + 
     &          ame**2*kp4*2D0*(p1p2 + ame**2*2D0) - 
     &          ame**2*p1p2*p2p3*4D0 + ame**2*kp2*p2p3*6D0 - 
     &          p2p4*1D0*
     &           (ame**2*(m1**2 + ame**2*2D0 + m2**2*2D0) + 
     &             p1p2*(m2**2 - ame**2*4D0) + 
     &             kp2*(-(m2**2*1D0) + ame**2*6D0))) + 
     &       kp1**2*(kp2**2*m2**2*p1p3 + 
     &          ame**2*m2**2*p1p2*p1p3 + ame**4*m1**2*p1p4 + 
     &          ame**2*kp2*m1**2*p1p4 + 
     &          ame**2*kp2*m2**2*p1p4 + kp2*m2**2*p1p2*p1p4 + 
     &          kp2*m2**2*p1p2*p2p3 - ame**4*m1**2*p1p3*1D0 - 
     &          ame**2*kp2*m1**2*p1p3*1D0 - 
     &          ame**2*kp2*m2**2*p1p3*1D0 - 
     &          kp2*m2**2*p1p2*p1p3*1D0 - 
     &          kp2**2*m2**2*p1p4*1D0 - 
     &          ame**2*m2**2*p1p2*p1p4*1D0 - 
     &          ame**4*m2**2*p2p3*1D0 - 
     &          kp2**2*m2**2*p2p3*1D0 - 
     &          ame**2*m1**2*p1p2*p2p3*1D0 + 
     &          ame**6*p1p3*2D0 - ame**2*p1p2**2*p1p3*2D0 - 
     &          ame**6*p1p4*2D0 + ame**2*p1p2**2*p1p4*2D0 - 
     &          ame**6*p2p3*2D0 - ame**4*kp2*p2p3*2D0 + 
     &          ame**2*kp2*m1**2*p2p3*2D0 - 
     &          ame**2*m2**2*p1p2*p2p3*2D0 - 
     ...
     &          kp4*(ame**4*(m1**2 + m2**2 - ame**2*1D0)*
     &              2D0 + p1p2**2*(m2**2 - ame**2*2D0) + 
     &             kp2*(-(m2**2*p1p2*1D0) + ame**4*2D0 - 
     &                ame**2*m2**2*2D0) + 
     &             ame**2*p1p2*
     &              (m1**2 + m2**2*2D0 - ame**2*8D0)) + 
     &          kp3*(ame**4*(ame**2 - m1**2*1D0 - m2**2*1D0)*
     &              2D0 + 
     &             p1p2**2*(-(m2**2*1D0) + ame**2*2D0) + 
     &             kp2*(m2**2*p1p2 - ame**4*2D0 + 
     &                ame**2*m2**2*2D0) + 
     &             ame**2*p1p2*
     &              (-(m1**2*1D0) - m2**2*2D0 + ame**2*8D0))
     &           - ame**2*kp2*p1p2*p2p3*1.2D1 + 
     &          p2p4*(ame**4*(m2**2 + ame**2*2D0) + 
     &             kp2**2*(m2**2 - ame**2*6D0) + 
     &             ame**2*p1p2*
     &              (m1**2 + m2**2*2D0 - p1p2*6D0) + 
     &             kp2*(ame**2*(ame + m1)*(ame - m1*1D0)*
     &                 2D0 + 
     &                p1p2*(-(m2**2*1D0) + ame**2*1.2D1)))) + 
     &       kp1*(kp2**3*m2**2*p1p3 + 
     &          ame**2*kp2*m2**2*p1p2*p1p3 + 
     &          ame**4*kp2*m2**2*p1p4 + 
     &          ame**4*m1**2*p1p2*p1p4 + 
     &          ame**4*m2**2*p1p2*p1p4 + 
     &          kp2**2*m2**2*p1p2*p1p4 + 
     &          ame**2*m1**2*p1p2**2*p1p4 + 
     &          ame**2*m2**2*p1p2**2*p1p4 + 
     &          ame**4*kp2*m1**2*p2p3 + 
     &          ame**4*m1**2*p1p2*p2p3 + 
     &          ame**4*m2**2*p1p2*p2p3 + 
     &          ame**2*m1**2*p1p2**2*p2p3 + 
     &          ame**2*m2**2*p1p2**2*p2p3 - 
     &          ame**4*kp2*m2**2*p1p3*1D0 - 
     &          ame**4*m1**2*p1p2*p1p3*1D0 - 
     &          ame**4*m2**2*p1p2*p1p3*1D0 - 
     &          kp2**2*m2**2*p1p2*p1p3*1D0 - 
     &          ame**2*m1**2*p1p2**2*p1p3*1D0 - 
     &          ame**2*m2**2*p1p2**2*p1p3*1D0 - 
     &          kp2**3*m2**2*p1p4*1D0 - 
     &          ame**2*kp2*m2**2*p1p2*p1p4*1D0 - 
     &          ame**2*kp2**2*m2**2*p2p3*1D0 - 
     &          ame**2*kp2*m1**2*p1p2*p2p3*1D0 + 
     &          ame**4*kp2**2*p1p3*2D0 - 
     &          ame**2*kp2**2*m1**2*p1p3*2D0 + 
     &          ame**2*kp2*m1**2*p1p2*p1p3*2D0 - 
     &          ame**4*kp2**2*p1p4*2D0 + 
     &          ame**2*kp2**2*m1**2*p1p4*2D0 - 
     &          ame**2*kp2*m1**2*p1p2*p1p4*2D0 + 
     &          ame**4*kp2*m2**2*p2p3*2D0 - 
     ...
     &          kp3*(kp2*(ame**2 + p1p2)*
     &              (p1p2*(m2**2 - ame**2*2D0) + 
     &                ame**2*(m1**2 + m2**2 + ame**2*2D0)) + 
     &             kp2**2*
     &              (ame**2*(ame + m2)*(ame - m2*1D0)*2D0 + 
     &                p1p2*(-(m2**2*1D0) + ame**2*2D0)) + 
     &             ame**4*(ame**2 + p1p2)*
     &              (m1**2 + m2**2 - p1p2*4D0)) + 
     &          kp4*(kp2**2*
     &              (-(ame**2*(ame + m2)*(ame - m2*1D0)*
     &                   2D0) + p1p2*(m2**2 - ame**2*2D0)) - 
     &             kp2*(ame**2 + p1p2)*1D0*
     &              (p1p2*(m2**2 - ame**2*2D0) + 
     &                ame**2*(m1**2 + m2**2 + ame**2*2D0)) - 
     &             ame**4*(ame**2 + p1p2)*1D0*
     ...
     &              (m1**2 + m2**2 - p1p2*4D0) + 
     &             kp2**2*
     &              (-(m2**2*1D0) + ame**2*4D0 - p1p2*4D0) + 
     &             kp2*(-(m1**2*p1p2*1D0) + 
     &                ame**2*(m1**2 + m2**2*2D0) + p1p2**2*8D0
     ...
     &       ame**2*kp1*2D0)) + 
     &  (C0aex25x34m1em2*
     &     (kp1**3*(-(kp2*m1**2*p2p3*1D0) - ame**4*kp3*4D0 + 
     &          ame**4*kp4*4D0 - ame**4*p1p3*4D0 + 
     &          ame**4*p1p4*4D0 + ame**4*p2p3*4D0 + 
     &          ame**2*kp2*p2p3*6D0 + 
     &          p2p4*(-(ame**4*4D0) + 
     &             kp2*(m1**2 - ame**2*6D0))) + 
     &       kp2*(ame**4*kp2*m1**2*p1p3 + 
     &          ame**2*kp2*m2**2*p1p2*p1p3 + 
     &          ame**2*kp2**2*m2**2*p1p4 + 
     &          ame**4*m1**2*p1p2*p1p4 + 
     &          kp2**2*m1**2*p1p2*p1p4 + 
     &          ame**4*m2**2*p1p2*p1p4 + 
     &          ame**2*m1**2*p1p2**2*p1p4 + 
     &          ame**2*m2**2*p1p2**2*p1p4 + 
     &          ame**4*kp2*m2**2*p2p3 + 
     ...
     &          ame**2*m1**2*p1p2**2*p2p3 + 
     &          ame**2*m2**2*p1p2**2*p2p3 - 
     &          ame**2*kp2**2*m2**2*p1p3*1D0 - 
     &          ame**4*m1**2*p1p2*p1p3*1D0 - 
     &          kp2**2*m1**2*p1p2*p1p3*1D0 - 
     &          ame**4*m2**2*p1p2*p1p3*1D0 - 
     &          ame**2*m1**2*p1p2**2*p1p3*1D0 - 
     &          ame**2*m2**2*p1p2**2*p1p3*1D0 - 
     &          ame**4*kp2*m1**2*p1p4*1D0 - 
     &          ame**2*kp2*m2**2*p1p2*p1p4*1D0 - 
     &          ame**2*kp2*m1**2*p1p2*p2p3*1D0 + 
     &          ame**6*kp2*p1p3*2D0 - 
     &          ame**4*kp2**2*p1p3*2D0 - 
     ...
     &             p1p2*(ame**2 + p1p2)*1D0*
     &              (m1**2 + m2**2 - p1p2*4D0) + 
     &             kp2*(-(ame**2*m2**2*1D0) + ame**4*2D0 + 
     &                p1p2*(m1**2 - p1p2*2D0 + ame**2*4D0)))
     &           - ame**2*kp2*p1p2**2*p1p3*6D0 + 
     &          ame**2*kp2*p1p2**2*p1p4*6D0 + 
     &          kp3*(ame**2*kp2**2*2D0*(p1p2 + ame**2*2D0) - 
     &             ame**4*(ame**2 + p1p2)*1D0*
     &              (m1**2 + m2**2 - p1p2*4D0) + 
     &             kp2*(ame**4*(m1**2 + m2**2 - ame**2*1D0)*
     &                 2D0 + p1p2**2*(m1**2 - ame**2*2D0) + 
     &                ame**2*p1p2*
     &                 (m2**2 + m1**2*2D0 - ame**2*8D0))) + 
     &          kp4*(ame**4*x25*(m1**2 + m2**2 + kp2*2D0) + 
     &             p1p2*(ame**4*
     &                 (m1**2 + m2**2 - ame**2*4D0) - 
     &                p1p2*1D0*
     &                 (kp2*(m1**2 - ame**2*2D0) + ame**4*4D0)
     &                  + ame**2*kp2*
     &                 (-(m2**2*1D0) - kp2*2D0 - m1**2*2D0 + 
     &                   ame**2*8D0)))) + 
     &       kp1*(ame**6*m1**2*p1p3 + kp2**3*m1**2*p1p3 + 
     &          ame**6*m2**2*p1p3 + ame**4*m1**2*p1p2*p1p3 + 
     &          ame**4*m2**2*p1p2*p1p3 + 
     &          ame**2*kp2*m2**2*p1p2*p1p3 + 
     &          ame**4*kp2*m2**2*p1p4 + 
     &          kp2**2*m1**2*p1p2*p1p4 + 
     &          ame**4*kp2*m1**2*p2p3 + 
     &          ame**2*kp2**2*m1**2*p2p3 + 
     &          ame**2*kp2**2*m2**2*p2p3 + 
     &          kp2**2*m1**2*p1p2*p2p3 - 
     &          ame**4*kp2*m2**2*p1p3*1D0 - 
     &          kp2**2*m1**2*p1p2*p1p3*1D0 - 
     &          ame**6*m1**2*p1p4*1D0 - 
     &          kp2**3*m1**2*p1p4*1D0 - 
     &          ame**6*m2**2*p1p4*1D0 - 
     &          ame**4*m1**2*p1p2*p1p4*1D0 - 
     &          ame**4*m2**2*p1p2*p1p4*1D0 - 
     &          ame**2*kp2*m2**2*p1p2*p1p4*1D0 - 
     &          ame**6*m1**2*p2p3*1D0 - 
     &          ame**6*m2**2*p2p3*1D0 - 
     &          ame**4*m1**2*p1p2*p2p3*1D0 - 
     &          ame**2*kp2*m1**2*p1p2*p2p3*1D0 - 
     &          ame**4*m2**2*p1p2*p2p3*1D0 + 
     &          ame**4*kp2**2*p1p3*2D0 - 
     &          ame**4*kp2*m1**2*p1p3*2D0 - 
     &          ame**2*kp2**2*m2**2*p1p3*2D0 - 
     &          ame**4*kp2**2*p1p4*2D0 + 
     &          ame**4*kp2*m1**2*p1p4*2D0 + 
     &          ame**2*kp2**2*m2**2*p1p4*2D0 + 
     &          ame**2*kp2**3*p2p3*2D0 - 
     &          ame**2*kp2*m2**2*p1p2*p2p3*2D0 - 
     &          ame**6*p1p2*p1p3*4D0 - 
     &          ame**4*p1p2**2*p1p3*4D0 + 
     &          ame**6*p1p2*p1p4*4D0 + 
     &          ame**4*p1p2**2*p1p4*4D0 + 
     ...
     &              (m1**2 + m2**2 - p1p2*4D0) - 
     &             kp2**2*1D0*
     &              (ame**2*(m1**2 + m2**2 + ame**2*4D0) + 
     &                p1p2*(m1**2 - ame**2*6D0)) + 
     &             ame**2*kp2*
     &              (-(ame**2*m1**2*1D0) + 
     &                p1p2*
     &                 (m1**2 + m2**2*2D0 - ame**2*4D0 - 
     &                   p1p2*1.2D1)))) + 
     &       kp1**2*(ame**2*kp2*m1**2*p1p3 + 
     &          kp2**2*m1**2*p1p3 + ame**4*m1**2*p1p4 + 
     &          ame**4*m2**2*p1p4 + ame**4*m1**2*p2p3 + 
     &          ame**4*m2**2*p2p3 + kp2*m1**2*p1p2*p2p3 - 
     &          ame**4*m1**2*p1p3*1D0 - 
     &          ame**4*m2**2*p1p3*1D0 - 
     &          ame**2*kp2*m1**2*p1p4*1D0 - 
     &          kp2**2*m1**2*p1p4*1D0 - 
     &          kp2**2*m1**2*p2p3*1D0 - ame**4*kp2*p2p3*2D0 + 
     &          ame**2*kp2*m2**2*p2p3*2D0 + ame**6*p1p3*4D0 - 
     &          ame**4*kp2*p1p3*4D0 + 
     ...
     &                p1p2*(-(m1**2*1D0) + ame**2*2D0)) + 
     &             ame**4*
     &              (m1**2 + m2**2 - ame**2*4D0 - p1p2*8D0))
     &           + kp3*(kp2*
     &              (-(ame**2*(ame + m1)*(ame - m1*1D0)*
     &                   2D0) + p1p2*(m1**2 - ame**2*2D0)) + 
     &             ame**4*
     &              (-(m1**2*1D0) - m2**2*1D0 + ame**2*4D0 + 
     &                p1p2*8D0)) - 
     &          ame**2*kp2*p1p2*p2p3*1.4D1 + 
     &          p2p4*(kp2**2*(m1**2 - ame**2*6D0) + 
     &             ame**4*
     &              (-(m1**2*1D0) - m2**2*1D0 + ame**2*4D0 + 
     &                p1p2*8D0) + 
     &             kp2*(ame**2*(ame + m2)*(ame - m2*1D0)*
     &                 2D0 + 
     &                p1p2*(-(m1**2*1D0) + ame**2*1.4D1))))))/
     &   (kp1*kp2**2*(ampi**2 + p3p4)*
     &     (-(ame**4*1D0) + (kp1 - p1p2*1D0)**2 + 
     &       ame**2*kp2*2D0)) + 
     &  (B0ax34m1m2*(-(kp1**5*kp2*1D0*
