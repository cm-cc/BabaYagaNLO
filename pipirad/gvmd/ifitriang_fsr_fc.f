     ...
     &       ame**2*kp2*2D0)) + 
     &  (ame**2*B0aeem2*5.D-1*
     &     (ame**2*ampi**2*kp1**3*(kp3**2 - kp4**2*1D0)*4D0 + 
     &       kp3*kp4*(ame**2 + p1p2 - kp2*1D0)*
     &        (ame**2 - p1p2*1D0)*
     &        (-(kp3**2*(p1p4 + p2p4)*1D0) - 
     &          kp4*1D0*(kp4*(p1p3 + p2p3) + 
     &             p1p3*(p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     ...
     &             kp4*(p1p3 + p1p4 + p2p3 + p2p4 + 
     &                ame**2*4D0 - p1p2*4D0))) - 
     &       kp1**2*2D0*(ampi**2*kp4**2*
     &           (kp2**2 + p1p2**2 - ame**4*1D0 - 
     &             kp2*(ame**2 + p1p2)*2D0 + 
     &             ame**2*(p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &              2D0) + 
     &          kp3**2*(-(ampi**2*kp2**2*1D0) - 
     &             ampi**2*p1p2**2*1D0 - kp4*p1p2*p2p4*1D0 + 
     &             ampi**2*kp2*(ame**2 + p1p2)*2D0 + 
     &             ame**2*
     &              (ampi**2*p1p3*2D0 - 
     &                p1p4*2D0*(ampi**2 - kp4*2D0) + 
     &                ampi**2*(ame**2 - p2p3*2D0) + 
     &                p2p4*(ampi**2*2D0 - kp4*3D0))) - 
     &          kp3*kp4*1D0*
     &           (ame**2*p3p4*
     &              (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*4D0 + 
     &             kp4*(ame**2*p1p3*4D0 + 
     &                p2p3*(p1p2 - ame**2*5D0)))) + 
     &       kp1*(ampi**2*kp2**3*(kp4**2 - kp3**2*1D0)*2D0 + 
     &          kp2**2*2D0*
     &           (kp3*kp4*
     &              (kp4*(p1p3 - p2p3*1D0) + 
     ...
     &                kp4*
     &                 (ame**2*ampi**2 + 
     &                   p2p3*2D0*(p1p4 + ame**2*2D0) + 
     &                   p1p3*2D0*
     &                    (p2p4 - p2p3*2D0 - ame**2*3D0) + 
     &                   p1p2*(ampi**2 + p2p3*4D0 - p1p3*6D0))
     &                ) + 
     &             kp3**2*
     &              (ampi**2*(ame**2 + p1p2)*
     &                 (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0
     &                  + kp4*
     &                 (ame**2*ampi**2 - ame**2*p3p4*1D0 + 
     &                   p2p4*2D0*(p1p3 - ame**2*2D0) + 
     &                   p1p4*2D0*
     &                    (ame**2 + p2p3 - p2p4*2D0) + 
     &                   p1p2*
     &                    (ampi**2 - p3p4*1D0 + p1p4*2D0 - 
     &                     p2p4*4D0)) - ame**2*kp4**2*8D0)) + 
     &          kp2*(ampi**2*kp4**2*2D0*
     &              (p1p2**2 - ame**4*1D0 + 
     &                p1p2*
     &                 (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0
     &                ) + 
     ...
     &                 (ame**2*(ampi**2 - p3p4*1D0) + 
     &                   p1p2*
     &                    (p3p4 - ampi**2*1D0 - p1p3*8D0 + 
     &                     p2p3*8D0))) + 
     &             kp3**2*
     &              (ampi**2*2D0*
     &                 (ame**4 - 
     &                   p1p2*1D0*
     &                    (p1p2 - p1p3*2D0 + p1p4*2D0 + 
     &                     p2p3*2D0 - p2p4*2D0)) + 
     &                kp4**2*(p1p2 - ame**2*1D0)*4D0 + 
     &                kp4*
     &                 (ame**2*(ampi**2 - p3p4*1D0) + 
     &                   p1p2*
     &                    (p3p4 - ampi**2*1D0 + p1p4*8D0 - 
     &                     p2p4*8D0)))))))/
     &   (kp1*kp3**2*kp4**2*(ame**4 - p1p2**2*1D0)*
     &     (-(ame**4*1D0) + (kp2 - p1p2*1D0)**2 + 
     &       ame**2*kp1*2D0)) + 
     &  (ame**2*B0aeem1*5.D-1*
     &     (ampi**2*kp1**3*kp2*(kp3**2 - kp4**2*1D0)*2D0 + 
     &       ame**2*ampi**2*kp2**3*(kp4**2 - kp3**2*1D0)*
     &        4D0 + kp1**2*
     &        (ampi**2*kp2**2*(kp4**2 - kp3**2*1D0)*2D0 + 
     &          kp2*2D0*(kp3*kp4*
     &              (kp4*(p1p3 - p2p3*1D0) + 
     &                p3p4*(p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)
     &                )*2D0 + 
     ...
     &          kp3*kp4*(ame**2*p3p4*
     &              (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*4D0 + 
     &             kp4*(p1p3*(p1p2 + ame**2*3D0) - 
     &                ame**2*p2p3*4D0)) + 
     &          kp3**2*(kp4*p1p2*p1p4 - ampi**2*p1p2**2*1D0 + 
     &             ame**2*
     &              (-(ampi**2*p1p3*2D0) - 
     &                p2p4*2D0*(ampi**2 - kp4*2D0) + 
     &                ampi**2*(ame**2 + p2p3*2D0) + 
     &                p1p4*(ampi**2*2D0 - kp4*5D0)))) + 
     &       kp2*(ame**2 - p1p2*1D0)*
     &        (ampi**2*kp4**2*(ame**2 + p1p2)*
     &           (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0 + 
     &          kp3*kp4*(-((ame**2 + p1p2)*p3p4*1D0*
     &                (kp4 + 
     &                  (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &                   4D0)) + 
     &             kp4*(ame**2*ampi**2 + 
     &                (ame**2 + p1p4)*p2p3*2D0 + 
     &                p1p3*2D0*(p2p4 - (ame**2 + p2p3)*2D0) + 
     &                p1p2*(ampi**2 + p2p3*2D0 - p1p3*4D0)))
     &           + kp3**2*
     &           (ampi**2*(ame**2 + p1p2)*
     &              (p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*2D0 + 
     &             kp4*(ame**2*ampi**2 - ame**2*p3p4*1D0 + 
     &                p1p4*2D0*
     &                 (p2p3 + ame**2*2D0 - p2p4*2D0) + 
     &                p2p4*2D0*(p1p3 - ame**2*3D0) + 
     &                p1p2*
     &                 (ampi**2 - p3p4*1D0 + p1p4*4D0 - 
     &                   p2p4*6D0)) - ame**2*kp4**2*8D0)) + 
     &       kp1*(ampi**2*kp2**2*(ame**2 + p1p2)*
     &           (kp3**2 - kp4**2*1D0)*4D0 + 
     &          kp3*kp4*(ame**2 - p1p2*1D0)*
     &           (kp3**2*(p1p4 + p2p4) + 
     ...
     &                ame**2*p1p3*2D0 + 
     &                p2p3*(-(m2**2*1D0) + ame**2*2D0)) + 
     &             ame**2*
     &              (p2p3*
     &                 (-(m1**2*1D0) + ame**2*2D0 + p1p4*2D0)
     &                 + p1p3*2D0*
     &                 (ame**2 + m2**2 + p2p4 - p2p3*2D0) + 
     &                (ampi**2 - p3p4*1D0)*
     &                 (m2**2 + ame**2*3D0))) + 
     &          kp3*(ame**2*ampi**2*p1p2 - 
     &             ame**2*m1**2*p2p4*1D0 - 
     &             m2**2*p1p2*p2p4*1D0 + ame**4*p1p4*2D0 + 
     &             ame**2*m2**2*p1p4*2D0 - 
     &             ame**2*p1p2*p1p4*2D0 + 
     &             ame**2*p1p4*p2p3*2D0 + ame**4*p2p4*2D0 + 
     &             ame**2*p1p2*p2p4*2D0 + 
     &             ame**2*p1p3*p2p4*2D0 + 
     &             ame**2*ampi**2*(m2**2 + ame**2*3D0) - 
     &             ame**2*p3p4*1D0*
     &              (m2**2 + p1p2 + ame**2*3D0) - 
     &             ame**2*p1p4*p2p4*4D0 - 
     &             ame**2*kp4*4D0*(m2**2 + ame**2*4D0) + 
     &             kp2*(ame**2*(ampi**2 - p3p4*1D0) + 
     &                p2p4*(m2**2 - ame**2*2D0) - 
     &                ame**2*kp4*4D0))) - 
     &       ame**2*1D0*(ame**2 + p1p2 - kp2*1D0)*
     &        (m1**2 + m2**2 + kp2*4D0 - p1p2*4D0)*
     &        (-(kp3**2*(p1p4 + p2p4)*1D0) - 
     &          kp4*1D0*(kp4*(p1p3 + p2p3) + 
     &             p1p3*(p1p3 + p2p4 - p1p4*1D0 - p2p3*1D0)*
     &              2D0) + 
     ...
     &                ame**2*4D0 - p1p2*4D0))) + 
     &       kp1*(-(ame**2*kp3**2*(p1p4 + p2p4)*
     &             (ame**2 + kp2 + m2**2 - p1p2*1D0)*2D0) + 
     &          kp4*(-(kp2**2*2D0*
     &                (m2**2*p1p3 + 
     &                  ame**2*(ampi**2 - p3p4*1D0)*3D0)) - 
     &             p1p2**2*2D0*
     &              (m2**2*(ampi**2 - p3p4*1D0) + 
     &                ame**2*p1p3*4D0) + 
     &             ame**2*
     &              (-(p2p3*2D0*
     &                   (kp4*(ame**2 + m2**2) + 
     ...
     &                   kp4*(ame**2 + m2**2)*1D0 + 
     &                   (ame**2 + m2**2)*p1p4*2D0 + 
     &                   p2p3*(m1**2 + m2**2 - ame**2*1D0)*
     &                    2D0 - p2p4*1D0*(m1**2 + m2**2*2D0))
     &                 - (ame**2 + m2**2)*p1p3**2*4D0 + 
     &                ame**2*p3p4*
     &                 (m1**2 - m2**2*1D0 - ame**2*4D0) + 
     &                ame**2*ampi**2*
     &                 (m2**2 - m1**2*1D0 + ame**2*4D0)) + 
     &             kp2*(ame**2*p3p4*
     &                 (m1**2 + m2**2 + ame**2*2D0) - 
     &                ame**2*ampi**2*1D0*
     &                 (m1**2 + m2**2 + ame**2*2D0) + 
     ...
     &                   p2p3*2D0*(m2**2 - ame**2*3D0) + 
     &                   ame**2*
     &                    (m1**2 + m2**2 - ame**2*4D0) + 
     &                   p2p4*(-(m2**2*1D0) + ame**2*4D0))))
     &           + kp3*(-(ame**2*ampi**2*m1**2*p1p2*1D0) - 
     &             ame**2*ampi**2*m2**2*p1p2*1D0 - 
     &             ampi**2*m2**2*p1p2**2*2D0 + 
     &             ame**4*m1**2*p1p4*2D0 + 
     &             ame**4*m2**2*p1p4*2D0 + 
     &             ame**2*m1**2*p1p2*p1p4*2D0 + 
     &             ame**2*m2**2*p1p2*p1p4*2D0 - 
     &             ame**2*m1**2*p1p4*p2p3*2D0 - 
     &             m2**2*p1p2*p1p4*p2p3*2D0 - 
     &             ame**2*m1**2*p1p3*p2p4*2D0 - 
     &             m2**2*p1p2*p1p3*p2p4*2D0 + 
     &             ame**4*ampi**2*p1p2*4D0 + 
     &             ame**4*p1p3*p1p4*4D0 + 
     &             ame**2*m2**2*p1p3*p1p4*4D0 - 
     &             ame**2*p1p2*p1p3*p1p4*4D0 - 
     &             ame**4*p1p4**2*4D0 - 
     &             ame**2*m2**2*p1p4**2*4D0 + 
     &             ame**2*p1p2*p1p4**2*4D0 - 
     &             ame**2*m2**2*p1p4*p2p3*4D0 + 
     &             ame**4*p1p3*p2p4*4D0 + 
     &             ame**2*p1p2*p1p3*p2p4*4D0 - 
     &             ame**4*p1p4*p2p4*4D0 + 
     &             ame**2*m1**2*p1p4*p2p4*4D0 + 
     &             ame**2*m2**2*p1p4*p2p4*4D0 + 
     &             m2**2*p1p2*p1p4*p2p4*4D0 + 
     &             ame**4*ampi**2*
     &              (m2**2 - m1**2*1D0 + ame**2*4D0) - 
     &             (ame**2 + p1p2)*p3p4*1D0*
     &              (-(m2**2*p1p2*2D0) + 
     &                ame**2*(m2**2 - m1**2*1D0 + ame**2*4D0))
     &               - ame**4*p1p2*p1p4*8D0 - 
     ...
     &                 (p2p3*(m2**2 - ame**2*4D0) + 
     &                   ame**2*
     &                    (m2**2 + p1p3*2D0 - p1p4*2D0 + 
     &                     ame**2*4D0)) + 
     &                kp4*2D0*
     &                 (-(p1p2*2D0*(m2**2 + ame**2*1.D1)) + 
     &                   ame**2*
     &                    (p1p3 + p1p4 + p2p3 + p2p4 + 
     &                     m1**2*2D0 + ame**2*1.2D1))) + 
     &             kp4*2D0*
     &              (ame**2*(ame**2 + m2**2)*
     &                 (p1p3 + p1p4 + p2p3 + p2p4) + 
     &                ame**4*2D0*
     &                 (m2**2 + m1**2*2D0 - ame**2*4D0) + 
     &                p1p2**2*2D0*(m2**2 + ame**2*4D0) - 
     &                ame**2*p1p2*1D0*
     &                 (p1p3 + p1p4 + p2p3 + p2p4 + 
     &                   ame**2*1.6D1)) + 
     &             kp2**2*
     ...
     &                   p2p4*2D0 - p2p3*4D0))) + 
     &          kp3*(p1p2*
     &              (p1p4*(-(m1**2*1D0) + ame**2*2D0) + 
     &                ame**2*(ampi**2 - p3p4*1D0 - p2p4*2D0))
     &              - ame**2*kp4*4D0*(m1**2 + ame**2*4D0) + 
     &             ame**2*
     &              ((ame**2 + m1**2 + p1p3)*p2p4*2D0 + 
     &                (ampi**2 - p3p4*1D0)*
     &                 (m1**2 + ame**2*3D0) + 
     ...
     &             (ame**2 + m1**2 - p1p2*1D0)*2D0) + 
     &          kp4*(ame**2*2D0*
     &              (-(kp4*(ame**2 + m1**2)*(p1p3 + p2p3)*
     &                   1D0) + 
     &                p2p4*
     &                 ((ame**2 + m1**2)*p2p3*2D0 + 
     &                   p1p3*(-(m2**2*1D0) + ame**2*2D0)) + 
     &                p2p3*
     &                 (ame**2*(m1**2 + m2**2) - 
     &                   (ame**2 + m1**2)*p2p3*2D0 + 
     &                   p1p3*(m1**2 + m2**2 - ame**2*1D0)*
     &                    2D0 - p1p4*1D0*(m2**2 + m1**2*2D0)))
     &               + ame**4*p3p4*
     &              (m2**2 - m1**2*1D0 - ame**2*4D0) + 
     &             ame**4*ampi**2*
     &              (m1**2 - m2**2*1D0 + ame**2*4D0) - 
     &             p1p2**2*2D0*
     &              (m1**2*(ampi**2 - p3p4*1D0) + 
     &                ame**2*p2p3*4D0) + 
     ...
     &                 (-(m1**2*1D0) - m2**2*1D0 + ame**2*4D0)
     &                  + p2p3*2D0*
     &                 (p1p3*2D0*(m1**2 - ame**2*3D0) + 
     &                   ame**2*
     &                    (m1**2 + m2**2 + p2p3*2D0 - 
     &                     ame**2*4D0) + 
     &                   p1p4*(-(m1**2*1D0) + ame**2*4D0))))
     &           + kp3*(-(p1p2**2*2D0*
     &                (m1**2*(ampi**2 - p3p4*1D0) + 
     &                  ame**2*p2p4*4D0)) + 
     &             p1p2*(p1p4*2D0*
     &                 (p2p3*(-(m1**2*1D0) + ame**2*2D0) + 
     &                   p2p4*2D0*(m1**2 - ame**2*3D0)) + 
     &                ame**2*p2p4**2*4D0 + 
     &                ame**2*(ampi**2 - p3p4*1D0)*
     &                 (-(m1**2*1D0) - m2**2*1D0 + ame**2*4D0)
     &                  + p2p4*2D0*
     ...
     &                    (m1**2 + m2**2 - p2p3*2D0 - 
     &                     ame**2*4D0) + 
     &                   p1p3*(-(m1**2*1D0) + ame**2*4D0))) + 
     &             ame**2*
     &              (p2p4*2D0*
     &                 (ame**2*(m1**2 + m2**2) + 
     &                   (ame**2 + m1**2)*p2p3*2D0 - 
     &                   p1p3*1D0*(m2**2 + m1**2*2D0)) - 
     &                (ame**2 + m1**2)*p2p4**2*4D0 + 
     &                ame**2*(ampi**2 - p3p4*1D0)*
     &                 (m1**2 - m2**2*1D0 + ame**2*4D0) + 
     &                p1p4*
     &                 (p2p4*(m1**2 + m2**2 - ame**2*1D0)*
     &                    4D0 + 
     &                   p2p3*(-(m2**2*2D0) + ame**2*4D0))) + 
     &             kp4*(ame**2*(ame**2 + m1**2)*
     &                 (p1p3 + p1p4 + p2p3 + p2p4)*2D0 + 
     &                ame**4*4D0*
     &                 (m1**2 + m2**2*2D0 - ame**2*4D0) + 
     &                p1p2**2*4D0*(m1**2 + ame**2*4D0) - 
     &                ame**2*p1p2*2D0*
     &                 (p1p3 + p1p4 + p2p3 + p2p4 + 
     &                   ame**2*1.6D1)))) + 
     ...
     &                kp4*4D0*
     &                 (m1**2 + m2**2 + p1p3 + p1p4 + p2p3 + 
     &                   p2p4 - p1p2*1.2D1)) + 
     &             kp2*(-(m1**2*p2p4*2D0) + 
     &                ame**2*(p3p4 - ampi**2*1D0)*6D0 + 
     &                ame**2*kp4*2.4D1))) + 
     &       kp1*(ame**2*kp3**2*(p1p4 + p2p4)*
     &           (-(m1**2*1D0) - m2**2*1D0 - kp2*2D0 + 
     &             ame**2*4D0 + p1p2*8D0) + 
     &          kp4*(-(kp2**2*2D0*
     &                (ame**2*(ampi**2 - p3p4*1D0) + 
     &                  p1p3*(m1**2 - ame**2*2D0))) + 
     ...
     &                 (p1p4*(m1**2 - ame**2*4D0) + 
     &                   ame**2*
     &                    (m1**2 - p2p3*2D0 + ame**2*4D0) + 
     &                   p1p3*(-(m1**2*2D0) + ame**2*6D0))) + 
     &             ame**2*
     &              (ame**2*ampi**2*(m1**2 + m2**2) - 
     &                ame**2*(m1**2 + m2**2)*p3p4*1D0 + 
     ...
     &          kp3*(kp2**2*
     &              (ame**2*(p3p4 - ampi**2*1D0)*2D0 + 
     &                p1p4*(-(m1**2*2D0) + ame**2*4D0) + 
     &                ame**2*kp4*8D0) + 
     &             kp2*(p1p4*p2p3*2D0*(m1**2 - ame**2*2D0) + 
     &                ame**2*p3p4*
     &                 (m1**2 + m2**2 + ame**2*2D0) - 
     &                ame**2*ampi**2*1D0*
     &                 (m1**2 + m2**2 + ame**2*2D0) - 
     ...
     &                   ame**2*
     &                    (m1**2 + p2p3*2D0 + ame**2*4D0) + 
     &                   p1p4*(-(m1**2*2D0) + ame**2*6D0)) + 
     &                kp4*2D0*
     &                 (-(p1p2*2D0*(m1**2 + ame**2*1.D1)) + 
     &                   ame**2*
     &                    (p1p3 + p1p4 + p2p3 + p2p4 + 
     &                     m2**2*2D0 + ame**2*1.2D1))) + 
     &             ame**2*
     &              (ame**2*ampi**2*(m1**2 + m2**2) - 
     &                ame**2*(m1**2 + m2**2)*p3p4*1D0 + 
