     ...
     &           ame**2*ampi**2*1D0) - p1p2*p1p3*p2p3*2D0)))
        elmat2 = -((ep3*1D0*
     &      (ame**6*ampi**2*(kp1 + kp2)*
     &         (ampi**2 - p3p4*1D0) - 
     &        p1p3*1D0*(ampi**2*p1p2*
     &            (kp1**2*(p2p3 - p2p4*1D0) + 
     &              kp1*(kp4*p1p2 - kp3*p1p2*1D0 + 
     &                 kp2*(p1p4 + p2p3 - p1p3*1D0 - p2p4*1D0)
     &                 ) + 
     &              kp2*(kp3*p1p2 + kp2*p1p3 + kp2*p1p4 - 
     &                 kp4*p1p2*1D0 - p1p2*p1p3*2D0)) + 
     &           p1p3*2D0*
     &            (kp1*p2p3*
     &               (kp3*p1p2 + kp2*p1p3 - kp4*p1p2*1D0 - 
     &                 kp2*p1p4*1D0) + 
     &              kp1**2*p2p3*(p2p4 - p2p3*1D0) + 
     &              kp2*p1p2*
     &               (kp4*p2p3 + p1p2*p3p4 - p1p4*p2p3*1D0 - 
     &                 p1p3*p2p4*1D0 - kp2*p3p4*1D0 + 
     &                 p1p3*p2p3*2D0 + kp3*(p2p4 - p2p3*2D0)))
     &           ) + ame**4*
     &         (p1p3*p3p4*
     &            (kp2*(p1p3 + p2p3) + kp1*(p1p3 - p2p3*1D0))
     &            + ampi**4*kp1*(kp1 - kp2*3D0) - 
     &           ampi**2*1D0*
     &            (kp1**2*p3p4 + 
     &              kp2*(kp4*p1p3 + p2p3**2 + p1p3*p2p4 - 
     &                 p2p3*p2p4*1D0 - p1p3*p1p4*2D0 + 
     &                 kp3*(p1p4 - p1p3*2D0) + p1p3**2*3D0) + 
     &              kp1*(p1p3**2 + p2p3**2 - kp4*p1p3*1D0 - 
     &                 p1p3*p2p4*1D0 - p2p3*p2p4*1D0 + 
     &                 kp3*
     &                  (-(p1p4*1D0) + p1p3*2D0 - p2p3*2D0 + 
     &                    p2p4*2D0) - kp2*p3p4*3D0))) + 
     &        ame**2*(-(ampi**4*p1p2*1D0*
     &              (kp1*(kp2 + p1p2) + 
     &                kp2*(p1p2 - kp2*1D0) - kp1**2*2D0)) + 
     &           p1p3*(kp1**2*p3p4*(p1p3 + p2p3*2D0) + 
     &              kp2*(kp4*(p1p3**2 + p2p3**2) + 
     &                 p1p3**2*p2p4 + p1p2*p2p3*p3p4 - 
     &                 p1p3*p1p4*p2p3*1D0 - 
     &                 p1p4*p2p3**2*1D0 - 
     &                 p1p3*p2p3*p2p4*1D0 - 
     &                 p1p2*p1p3*p3p4*1D0 - 
     &                 kp2*p2p3*p3p4*1D0 + p1p3**3*2D0 - 
     &                 p1p3**2*p1p4*2D0 + p1p3*p2p3**2*2D0 + 
     &                 kp3*
     &                  (p1p3*p1p4 - p1p3**2*2D0 + 
     &                    p2p3*(p2p4 - p2p3*2D0))) - 
     &              kp1*1D0*
     &               (kp4*(p1p3**2 + p2p3**2) + 
     &                 p1p3**2*p2p4 + p1p3*p2p3*p2p4 + 
     &                 kp2*p2p3*p3p4 + p1p2*p2p3*p3p4 - 
     &                 p1p3*p1p4*p2p3*1D0 - 
     &                 p1p4*p2p3**2*1D0 - 
     &                 p1p2*p1p3*p3p4*1D0 + 
     &                 kp3*
     &                  (p1p3*p1p4 - p2p3*p2p4*1D0 - 
     &                    p1p3**2*2D0 + p1p4*p2p3*2D0 - 
     &                    p1p3*p2p4*2D0) + kp2*p1p3*p3p4*3D0))
     &             + ampi**2*
     &            (-(kp1**2*1D0*
     &                 (p1p3**2 + p2p3**2 - p2p3*p2p4*1D0 + 
     &                   p1p3*p2p3*2D0 + p1p2*p3p4*2D0)) + 
     &              kp2*(kp2*p1p4*p2p3 + p1p2**2*p3p4 + 
     &                 p1p2*
     &                  (kp3*p2p4 - kp3*p2p3*1D0 - 
     &                    p1p4*p2p3*1D0 - kp2*p3p4*1D0 + 
     &                    p1p3*(p1p4 + p2p3*2D0 - p2p4*2D0)))
     &               + kp1*
     &               (kp3*p1p2*
     &                  (p2p3 - p2p4*1D0 - p1p3*2D0 + 
     &                    p1p4*2D0) + 
     &                 p1p2*
     &                  (p1p2*p3p4 - p1p3*p1p4*1D0 - 
     &                    p1p4*p2p3*1D0 + p1p3*p2p3*2D0) + 
     &                 kp2*
     &                  (p2p3**2 + p1p2*p3p4 - 
     &                    p1p4*p2p3*1D0 - p2p3*p2p4*1D0 + 
     &                    p1p3*p2p3*2D0 + p1p3**2*3D0))))))/
     &    (kp1*kp2*(ampi**2 + p3p4)*
     &      (ame**4*ampi**2 - 
     &        ame**2*(p1p3**2 + p2p3**2)*1D0 + 
